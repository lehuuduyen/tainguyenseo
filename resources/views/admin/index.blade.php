...
<body data-role="page" style="" cz-shortcut-listen="true">
    ...
    <div class="pinky-template">
        ...
        <header class="fl-header " data-target="primary-header-container">
            <div class="primary-navigation-section " data-target="primary-header"
                fl-analytics-section="DaVinciNavigation">
                <div class="navigation-section-inner">

                    <!-- Header left hand side container -->
                    <div>
                        <!-- Logo container-->
                        <div class="fl-logo-container">
                            <a class="fl-logo" href="/" fl-analytics="PrimaryLogo" data-qtsb-section="NavBar"
                                data-qtsb-label="Home" id="nav-home">
                                <img class="flicon-logo-fullcolor"
                                    src="https://vecta.io/blog/best-practices-for-svg-seo-in-google-image/best-practices-for-svg-seo-in-google-image.png"
                                    alt="Freelancer Logo">
                            </a>
                        </div>
                        ...
                        <nav class="primary-navigation">
                            <ul class="primary-navigation-list">
                                <li>
                                    <a class="primary-navigation-link primary-navigation-link--noSubNav" href="/jobs/"
                                        data-qtsb-section="NavBar" data-qtsb-label="BrowseJobs" id="nav-browse-jobs">
                                        Tài nguyên </a>
                                </li>
                                <li>
                                    <a class="primary-navigation-link primary-navigation-link--noSubNav"
                                        href="/info/how-it-works/" data-qtsb-section="NavBar"
                                        data-qtsb-label="HowItWorks" id="nav-how-it-works">
                    ...
                    <div class="LoginSection">
                        ...
                        <fl-login-signup-angular fl-translation-crawler="" show-login-button="true"
                            show-signup-button="true">
                            <!-- ngIf: !LoginSignupAngular.loginSignupConfig.isModal() -->

                            <!-- ngIf: LoginSignupAngular.loginSignupConfig.options.showAppLinks && LoginSignupAngular.loginSignupConfig.isModal() && LoginSignupAngular.loginSignupConfig.options.visible -->

                            <!-- ngIf: !LoginSignupAngular.loginSignupConfig.options.showAppLinks && LoginSignupAngular.loginSignupConfig.isModal() && LoginSignupAngular.loginSignupConfig.options.visible -->


                            <!-- ngIf: LoginSignupAngular.showLoginButton --><a
                                ng-if="LoginSignupAngular.showLoginButton"
                                ng-click="LoginSignupAngular.showLoginModal($event)" class="LoginSection-btn"
                                href="/login" rel="nofollow"
                                ng-class="{'LoginSection-btn--arrow' : LoginSignupAngular.enterprise === 'arrow'}"
                                data-uitest-target="login-button" data-qtsb-section="NavBar"
                                data-qtsb-label="ShowLoginSplash" i18n-id="3bbbad631029e3575da7a151bba4f37c"
                                i18n-msg="Log In">Log In</a><!-- end ngIf: LoginSignupAngular.showLoginButton -->

                            <!-- ngIf: LoginSignupAngular.showSignupButton --><a
                                ng-if="LoginSignupAngular.showSignupButton"
                                ng-click="LoginSignupAngular.showSignupModal($event)" class="LoginSection-btn"
                                href="/signup" rel="nofollow"
                                ng-class="{'LoginSection-btn--arrow' : LoginSignupAngular.enterprise === 'arrow'}"
                                data-uitest-target="signup-button" data-qtsb-section="NavBar"
                                data-qtsb-label="ShowHireSignupSplash" i18n-id="d67850bd126f070221dcfd5fa6317043"
                                i18n-msg="Sign Up">Sign Up</a><!-- end ngIf: LoginSignupAngular.showSignupButton -->
                        </fl-login-signup-angular>
    ...
    <aside class="PostProjectBanner" id="post-project-banner">
        <div class="Container">
            <div class="Grid Grid--verticalCenter">
                <div class="Grid-col Grid-col--desktopSmall-7">
                    <h2 class="PostProjectBanner-heading">Bạn cần tìm kiếm tài nguyên seo?</h2>
                    <p class="PostProjectBanner-byLine">
                        Đăng ký miễn phí để làm nhà cung ứng tài nguyên </p>
                </div>
                <div class="Grid-col Grid-col--desktopSmall-5">
                    <form action="/post-project" method="get">
                        <div class="InputCombo InputCombo--highlighted">
                            <div class="InputCombo-inner">
                                <label for="post-project-banner-form-input" class="is-accessibly-hidden">
                                    Bạn cần tìm kiếm tài nguyên?
                                </label>
                                <input id="post-project-banner-form-input" name="project_title"
                                    class="InputCombo-input large-input" type="text"
                                    placeholder=" Bạn cần tìm kiếm tài nguyên?">
                            </div>
                            <button class="InputCombo-btn btn btn-large btn-primary" data-post-btn=""
                                data-qtsb-section="page-job-search-new" data-qtsb-subsection="banner-one-click"
                                data-qtsb-label="button-submit">
                                Tìm kiếm
                            </button>
                        </div>
                    </form>
        ...
        <button class="PostProjectBanner-closeButton btn Button--basic" id="post-project-banner-close">
    ...
    <!-- polyfills -->
    <!-- load webapp compat polyfills first, as they have the coreJS browser polyfills -->
