                    ...
                    <div class="col-md-10">
                        ...
                        <div class="form-group <?=($categoryNeedIsValidate)?"":"d-none"?>  domain">
                            ...
                            <div class="invalid-feedback" style="<?=(!$postCategoryIsValidate)?"display:block":""?>">
                                Vui lòng <span type="button" data-toggle="modal" onclick="clickModal()"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="category_id" name="category_id" onchange="changeCategory(this)" <?=($postCategoryIsValidate)?"readonly":""?>
                                required>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <span jsslot="" class="PbnGhe oJeWuf fb0g6">
                            <div jscontroller="y5NZL" jsaction="LNlWBf:TvD9Pc;" data-resource-id="sc-domain:google.com"><c-wiz
                                    jsrenderer="W0jTE" data-is-verification-disabled="false" jsshadow="" jsdata="deferred-c1"
                                    data-p="%.@.&quot;sc-domain:google.com&quot;,1,1,&quot;https://search.google.com/search-console/welcome?sjid=16764114872218177151-AP&quot;]"
                                    jscontroller="jWo0Zb"
                                    jsaction="JIbuQc:acUjBc(acUjBc),Hbn3B(eDx0uf);aLn7Wb:CGTidc(oaYlK),RW4jGd(pdfcob);"
                                            ...
                                            <div class="D1E8p">
                                                <div class="wafqxf">
                                                    <div class="W8EZA">
                                                        ...
                                                        <div class="hTXuX">
                                                            <div class="hTXuX">Xác minh qua file txt: <b jsslot=""
                                                                    class="vRMGwf oJeWuf">verify.txt</b></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="wafqxf">
                                                        <div class="W8EZA">
                                                            ...
                                                            <div class="hTXuX"><span>Copy file txt này vào đường dẫn <b><span
                                                                            class="textDomain"></span>/verify.txt</span>
                                                                                </span>
                                                                </div>
                                                        </div>
                                                </div>
                                            <div class="fCyCnf">
                                                <div class="RDvAZb">
                                                    <div class="gVqAvf" jscontroller="l7DpL" jsaction="JIbuQc:p0xsmb(kImuFf)">
                                                        <div class="edhGSc zKHdkd xfUKk CDELXb" jscontroller="pxq3x"
                                                            jsaction="clickonly:KjsqPd; focus:Jt1EX; blur:fpfTEe; input:Lg5SV" jsshadow="">
                                                            <div class="RpC4Ne oJeWuf">
                                                                <div class="Pc9Gce Wic03c">
                                                                    <textarea id="copy" class="KHxj8b tL9Q4c" data-rows="1" tabindex="0" aria-label="" jscontroller="gZjhIf"
                                                                        jsaction="input:Lg5SV;ti6hGc:XMgOHc;rcuQ6b:WYd;" readonly="" dir="ltr" style="height: 20px;">google-site-verification=2os9zHlaNv5uifqt7vtOB3DK3lCL0oyTpnpaJhJ3MYc</textarea>
                                                                </div>
                                                        ...
                                                        <div role="button" class="U26fgb A9jyad O0WRkf oG5Srb HQ8yf C0oVfc HNax3b M9Bg4d"
                                                            jscontroller="VXdfxd"
                                                            ...
                                                            jsshadow="" aria-disabled="false" tabindex="0" data-verification-method="7">
                                                            <div class="Vwe4Vb MbhUzd"></div>
                                                            <div class="ZFr60d CeoRYc"></div><span jsslot="" class="CwaK9"><span onclick="copyText()"
                                                                    class="RveJvd snByac">Copy</span></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
