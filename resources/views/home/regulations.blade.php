                                        ...
                                        <div class="JobSearchCard-item-inner" data-project-card="true">
                                            <div class="JobSearchCard-primary">
                                                <div class="JobSearchCard-primary-heading">
                                                    ...
                                                    <div class="sec">
                                                        <h2>BƯỚC 1: CHỌN LOẠI MÀ BẠN CẦN GIAO DỊCH (<span style="color:#f04a51">Click vào ICON</span>)</h2>
                                                        <div class="step">
                                                        <img src="/static/home/img/site/GDPM.png" alt="Step 1">
                                                        <img src="/static/home/img/site/GDUSDT.png" alt="Step 1">
                                                        <img src="/static/home/img/site/GDWMZ.png" alt="Step 1">
                                                        </div>
                                                        <hr>
                                                        <h2>BƯỚC 2: CHỌN MUA HOẶC BÁN HOẶC TRAO ĐỔI ĐỂ THỰC HIỆN GIAO DỊCH (<span style="color:#f04a51">Click Mua hoặc Bán hoặc Trao Đổi</span>)</h2>
                                                        <div class="step">
                                                        <img src="/static/home/img/site/B2PM.png" alt="Step 2" style="max-width: 30%; ">
                                                        <img src="/static/home/img/site/B2USDT.png" alt="Step 2" style="max-width: 30%;">
                                                        </div>
                                                        <hr>
                                                        <h2>BƯỚC 3: ĐIỀN ĐẦY ĐỦ THÔNG TIN GIAO DỊCH (<span style="color:#f04a51">Hệ thống sẽ hiển thị tên của bạn</span>)</h2>
                                                        <div class="step">
                                                        <img src="/static/home/img/site/B3MUAPM.png" alt="Step 3" style="max-width: 48%;">
                                                        <img src="/static/home/img/site/B3BANUSDT.png" alt="Step 3" style="max-width: 48%;padding-left: 3%;">
                                                        </div>
                                                        <hr>
                                                        <h2>CHÚ THÍCH: CÁC THÔNG TIN VÀ LỰA CHỌN CẦN LƯU Ý KHI THỰC HIỆN</h2>
                                                        <div class="step1">
                                                        <p> Thông tin chi tiết số tiền VND bạn thanh toán hoặc bạn nhận được: <br>
                                                        <img src="/static/home/img/site/TTAMOUNT.png" alt="Step 3" style="max-width: 50%; ">
                                                        </p>
                                                        <p> Thông tin tên tài khoản, tên chủ ví:<br>
                                                        <img src="/static/home/img/site/TTBANK.png" alt="Step 3" style="max-width: 40%;">
                                                        <img src="/static/home/img/site/TTWALLET.png" alt="Step 3" style="max-width: 45%;"></p>
                                                        <p> Chọn loại PM hoặc loại Network USDT để thực hiện:<br>
                                                        <img src="/static/home/img/site/NETWORK.png" alt="Step 3" style="max-width: 40%; ">
                                                        <img src="/static/home/img/site/TYPEPM.png" alt="Step 3" style="max-width: 40%; "></p>
                                                        </div>
                                                        <hr>
                                                        <h2>BƯỚC 4: THÔNG TIN THANH TOÁN GIAO DỊCH (<span style="color:#f04a51">Chuyển tiền đúng thông tin</span>)</h2>
                                                        <div class="step">
                                                        <img src="/static/home/img/site/B4TTTT.png" alt="Step 4" style="max-width: 80%; ">
                                                        </div>
                                                        <h2>BƯỚC 5: GIAO DỊCH THÀNH CÔNG (<span style="color:#f04a51">Sau khi bạn chuyển tiền hệ thống tự động hoàn thành 10s</span>)</h2>
                                                        <div class="step">
                                                        <img src="/static/home/img/site/B5FINISH.png" alt="Step 5" style="max-width: 70%; ">
                                                        </div>
                                                        </div>
