                ...
                <div class="ProjectSearch-filterandresults Container fl-form">
                                    ...
                                    <div id="" class="ProjectSearch-header-pagination">
                                        <ul id="pagination-1021" class="Pagination">
                                            <li data-link="1" class="Pagination-item">
                                                <a href="https://www.freelancer.com/jobs" class="padding-top-bottom btn Pagination-link">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12" class="flicon-pagination-first">
                                                            <path d="M10 11L5 6l5-5M2.5 11c-.28 0-.5-.22-.5-.5v-9c0-.28.22-.5.5-.5s.5.22.5.5v9c0 .28-.22.5-.5.5z">
                                                            </path>
                                                        </svg>
                                                    </span>
                                                </a>
                                            ...
                                            <li data-link="prev_page" class="Pagination-item">
                                                <a href="https://www.freelancer.com/jobs" data-pagination-prev-button="" class="btn padding-top-bottom  paginate_button Pagination-link">
                                                    <span>
                                            ...
                                            <li data-link-id="0" data-link="1" class="Pagination-item">
                                                <a href="https://www.freelancer.com/jobs" class="btn number Pagination-link is-active">1</a>
                                            </li>
                                            ...
                                            <li data-link="next_page" class="Pagination-item">
                                                <a href="https://www.freelancer.com/jobs/2" data-pagination-next-button="" class="btn padding-top-bottom  Pagination-link">
                                                    <span>
                                            ...
                                            <li data-link="last_page" class="Pagination-item">
                                                <a href="https://www.freelancer.com/jobs/100" class="btn padding-top-bottom Pagination-link">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12" class="flicon-pagination-last">
                                                            <path d="M2 1l5 5-5 5M9.5 1c.28 0 .5.22.5.5v9c0 .28-.22.5-.5.5s-.5-.22-.5-.5v-9c0-.28.22-.5.5-.5z">
                                                            </path>
                                                        </svg>
                                                    </span>
                                                </a>
                    ...
                    <div class="ProjectSearch-footer">
                        <div class="ProjectSearch-footer-resultCounting">
                            Showing <span id="first-entry">1</span> to <span id="last-entry">50</span> of <span id="total-results-bottom">5,000 entries</span>
                        </div>
                        ...
                        <div id="" class="ProjectSearch-footer-pagination">
                            <ul id="" class="Pagination">
                                <li data-link="1" class="Pagination-item">
                                    <a href="https://www.freelancer.com/jobs" class="btn padding-top-bottom Pagination-link">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12" class="flicon-pagination-first">
                                                <path d="M10 11L5 6l5-5M2.5 11c-.28 0-.5-.22-.5-.5v-9c0-.28.22-.5.5-.5s.5.22.5.5v9c0 .28-.22.5-.5.5z">
                                                </path>
                                ...
                                <li data-link="prev_page" class="Pagination-item">
                                    <a href="https://www.freelancer.com/jobs" data-pagination-prev-button="" class="btn paginate_button padding-top-bottom Pagination-link">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12" class="flicon-pagination-prev">
                                                <path d="M8 11L3 6l5-5v10z"></path>
                                            </svg>
                                ...
                                <li data-link="next_page" class="Pagination-item">
                                    <a href="https://www.freelancer.com/jobs/2" data-pagination-next-button="" class="btn Pagination-link padding-top-bottom">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12" class="flicon-pagination-next">
                                                <path d="M4 1l5 5-5 5"></path>
                                            </svg>
                                ...
                                <li data-link="last_page" class="Pagination-item">
                                    <a href="https://www.freelancer.com/jobs/100" class="btn Pagination-link padding-top-bottom">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12" class="flicon-pagination-last">
                                                <path d="M2 1l5 5-5 5M9.5 1c.28 0 .5.22.5.5v9c0 .28-.22.5-.5.5s-.5-.22-.5-.5v-9c0-.28.22-.5.5-.5z">
                                                </path>
